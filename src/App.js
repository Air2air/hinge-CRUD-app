...
import Logo from "./images/hinge-logo.png";
              ...
              <div className="App-instructions">
                <ol>
                  ...
                  <li className="highlighted">
                    ...
                    <p>
                      For maintainability I like to limit css overrides, so just inlined Reactstrap with no custom css. I normally use node-sass but not here.
                    </p>
                  </li>
                  <li>
                  ...
                  <li className="highlighted">
                    ...
                    <p>
                      I know this can be done in Enzyme with toHaveStyle, but
                      don't know how to compare a non-explicit (calculated)
                      position value in Reactstrap (Ex. 'xs-4') with the
                      original rendered <code>$nbsp;</code> dimension. I could
                      do it using absolute div widths.
                    </p>
                  </li>
                  <li>
                    <i>
              ...
              <div className="App-instructions">
                <ol>
                  <li className="highlighted">
                    ...
                    that at level 2.
                    <p>
                      I tried but just couldn't decipher this placement
                      requirement, so I made an executive decision on the
                      placement.
                    </p>
                  </li>
                  <li>
